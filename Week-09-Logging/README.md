# Week 9 - Logging and Observability

## Investigation

You need evidence while the program keeps running. A debugger may be too disruptive, too late, or unavailable. Logs, traces, and profiles become the way to ask questions from outside the process.
...
Observability is debugging without stopping the world. Good logs and traces are not narration. They are structured answers to future questions.

The right signal depends on the boundary: program state, operating-system interaction, or time spent.
...
- propose a better future log, trace point, or measurement
